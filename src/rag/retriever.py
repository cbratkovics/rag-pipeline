...
class HybridRetriever:
    ...
    def __init__(
        ...
        self._corpus_metadata: list[dict[str, Any]] | None = None
    ...
    def rrf_combine(
        ...
        for doc_id in sorted_ids:
            ...
            scores = {"hybrid": rrf_scores[doc_id], "bm25": bm25_score, "vector": vector_score}
    ...
    def weighted_combine(
        ...
        bm25_dict = {
            r[0]: (r[1], r[2] / max_bm25 if max_bm25 > 0 else 0, r[3]) for r in bm25_results
        }
        vector_dict = {
            r[0]: (r[1], r[2] / max_vector if max_vector > 0 else 0, r[3]) for r in vector_results
        }
    ...
    def retrieve(
        ...
        if fusion_method == "rrf":
            ...
            combined = self.weighted_combine(
                bm25_results, vector_results, bm25_weight=bm25_weight, vector_weight=vector_weight
            )
        ...
        return {"contexts": contexts, "scores": scores, "metadata": metadata}
